...
#' Convert an R object into a YAML string.
#' 
#' @return Returns a YAML string which can be loaded using \code{\link{yaml.load}} or written into a file for external use.
#' @param x The object to be converted.
#' @param line.sep The line separator character(s) to use.
#' @param indent The number of spaces to use for indenting.
#' @param omap Determines whether or not to convert a list to a YAML omap; see Details.
#' @param column.major Determines how to convert a data.frame; see Details.
#' @param unicode Determines whether or not to allow unescaped unicode characters in output.
#' @param precision Number of significant digits to use when formatting numeric values.
#' @param indent.mapping.sequence Determines whether or not to indent sequences in mapping context.
#' @param handlers Mamed list of custom handler functions for R objects; see Details.
#' @details 
#' 
